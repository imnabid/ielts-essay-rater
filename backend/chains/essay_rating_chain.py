...
def build_rating_chain(llm: ChatOpenAI):
    # PDO prompt engineering with explicit structure and guardrails
    template = (
        ...
        "Output: Return a JSON with keys: band_scores, strengths, weaknesses, criterion_feedback, prioritized_actions, estimated_band_if_addressed.\n"
